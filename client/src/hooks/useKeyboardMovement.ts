 ...
 * Notes: Uses unified gesture library for consistency with touch/gesture input handling
 */
...
export function useKeyboardMovement({
  ...
  useEffect(() => {
    ...
    // Bind gesture handlers to window
    const cleanup = bind();
  ...
  }, [isEnabled, bind, stopMovement, onMovement]);
