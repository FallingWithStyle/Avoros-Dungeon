          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-4 items-center flex-wrap">
                ...
                <div className="flex flex-col items-center gap-1">
                  ...
                  <span className="text-xs text-slate-400">Enemies + Players</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3 mt-6">
              ...
              <div className="flex gap-4 items-center flex-wrap">
                ...
                <div className="flex flex-col items-center gap-1">
                  ...
                  <span className="text-xs text-slate-400">Enemies + 2 Players</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-2 mt-6 p-3 bg-slate-800/30 rounded">
              ...
              <div className="text-xs text-slate-500 mt-2">
                ...
                • Indicators stack when both are present
              </div>
            </div>
          </div>
        </CardContent>
